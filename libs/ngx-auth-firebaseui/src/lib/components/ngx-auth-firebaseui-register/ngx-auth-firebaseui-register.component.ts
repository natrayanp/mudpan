...
export class NgxAuthFirebaseuiRegisterComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    console.log("inside erg");
    console.log(this.config);
    this.registerForm = this.formBuilder.group({
      name: ['dsd', Validators.required],
      email: ['', [Validators.required, Validators.email]],
      password: ['d', [Validators.required,
                     Validators.minLength(this.config.passwordMinLength as number), 
                     Validators.maxLength(this.config.passwordMaxLength as number)]],
